...
class AssetsResource extends PackageResource
{
    ...
    public function __construct()
    {
        ...
        $this->description = 'The Laravel Chat required assets';
        ...
        $this->source = [
            'assets' => [
                'name' => 'LaravelChat v1',
                'source' => base_path('vendor/sunarctech/laravel-chat/'),
                'target' => public_path('vendor/laravel-chat/'),
                'resources' => [
                    [
                        'source' => 'dist/css',
                        'destination' => 'css',
    ...
    protected function installAsset($asset)
    {
        ...
        foreach ($asset['resources'] as $res) {
            ...
            $res['target'] = $asset['target'] . $res['destination'];
